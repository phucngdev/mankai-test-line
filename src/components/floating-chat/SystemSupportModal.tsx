...
function SystemSupportModal({ onClose, onBack }: SystemSupportModalProps) {
      ...
      <div className={styles.contentModal} onClick={e => e.stopPropagation()}>
        <div className={styles.contentModalHeader}>
          ...
          <div className={styles.headerContent}>
            <h3 className={styles.contentModalTitle}>Hỗ trợ kỹ thuật</h3>
          </div>
          <button
            aria-label="Đóng"
        ...
        <div className={styles.contentModalBody}>
          <div className={styles.formSection}>
            <label className={styles.formLabel}>Mô tả chi tiết vấn đề</label>
            ...
            >
              <div className={styles.uploadContent}>
                ...
                <p className={styles.uploadText}>
                  ...
                  <span className={styles.uploadLink}>minh chứng</span>
                </p>
...
export default SystemSupportModal;
